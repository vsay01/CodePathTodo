...
public class TasksDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + TasksPersistenceContract.TaskEntry.TABLE_NAME + " (" +
                    ...
                    TasksPersistenceContract.TaskEntry.COLUMN_NAME_DUE_DATE + TEXT_TYPE + COMMA_SEP +
                    TasksPersistenceContract.TaskEntry.COLUMN_NAME_PRIORITY + TEXT_TYPE + COMMA_SEP +
